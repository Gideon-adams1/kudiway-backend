...
urlpatterns = [
    ...
    path(
        "api/wallet/transfer-to-savings/",
        wallet_views.deposit_to_savings,
        name="deposit_to_savings",
    ),
    path(
        "api/wallet/withdraw/",
        wallet_views.withdraw_from_savings,
        name="withdraw_from_savings",
    ),
    path(
        "api/wallet/transactions/",
        wallet_views.transaction_history,
    ...
    # 💳 Credit / BNPL
    path(
        "api/wallet/credit-purchase/",
        wallet_views.make_credit_purchase,
        name="credit_purchase",
    ),
    path("api/wallet/repay/", wallet_views.repay_credit, name="repay_credit"),
    path(
        "api/wallet/credit-purchases/",
        wallet_views.credit_purchase_list,
        name="credit_purchase_list",
    ),
    path(
        "api/wallet/credit-score/",
        wallet_views.get_credit_score,
        name="get_credit_score",
    ),
    path(
        "api/wallet/request-limit-increase/",
        wallet_views.request_limit_increase,
    ...
    path(
        "api/kyc/approve/<int:kyc_id>/",
        wallet_views.approve_kyc_admin,
        name="approve_kyc_admin",
    ),
    path(
        "api/kyc/reject/<int:kyc_id>/",
        wallet_views.reject_kyc_admin,
        name="reject_kyc_admin",
    ),
    ...
    path(
        "checkout/<slug:ref_code>/",
        order_views.referral_checkout,
        name="referral_checkout_page",
    ),

    # 🎥 Global Video Reviews API (TikTok-style)
    path("api/reviews/", include("reviews.urls")),
]

# Media (KYC docs, product images, etc.)
