...
urlpatterns = [
    ...
    # ✅ NEW: Product-specific review feed
    # Tap product → watch only reviews for that product
    path("feed/product/", views.feed_product, name="feed_product"),
    ...
    # ============================
    # ✅ NEW: Store social-proof stats
    # Used by StoreScreen to show:
    # “🔥 3 creators reviewed this”
    # ============================
    path("stats/by-product/", views.review_stats_by_product, name="review_stats_by_product"),
]
